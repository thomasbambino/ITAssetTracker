...
export function EnhancedSearch() {
  ...
  return (
    <div className="relative w-full max-w-md">
      {/* Search field with clean styling and proper text rendering */}
      <div className="relative rounded-md border border-input bg-background ring-0">
        ...
        <Input
          ref={inputRef}
          type="text"
          className="pl-10 pr-10 border-0 shadow-none font-medium text-base ring-0 focus-visible:ring-0 focus:ring-0"
          style={{ WebkitFontSmoothing: 'antialiased', fontWeight: 500 }}
          placeholder="Search..."
      ...
      {/* Command dialog with improved styling */}
