  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8 mt-10 md:mt-0">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        <StatCard
          icon={<LaptopIcon className="h-6 w-6 xl:h-5 xl:w-5 text-primary-600" />}
        ...
        <StatCard
          icon={<UserCheckIcon className="h-6 w-6 xl:h-5 xl:w-5 text-green-600" />}
        ...
        <StatCard
          icon={<AlertTriangleIcon className="h-6 w-6 xl:h-5 xl:w-5 text-yellow-600" />}
        ...
        <StatCard
          icon={<CalendarXIcon className="h-6 w-6 xl:h-5 xl:w-5 text-red-600" />}
        ...
        <StatCard
          icon={<TicketIcon className="h-6 w-6 xl:h-5 xl:w-5 text-purple-600" />}
