...
- July 02, 2025. Fixed context-aware navigation for device detail pages. When navigating from user page to device, back button now shows "Back to User" and returns to user page instead of generic "Back to Devices".
