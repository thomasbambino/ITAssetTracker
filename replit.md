...
- July 02, 2025. Implemented automated device specification generator for non-laptop/desktop devices. System can generate specs for Apple devices (iPad, iPhone, AirPods, Apple Pencil, Magic accessories), Samsung devices, Microsoft Surface devices, and generic device categories. Generator accessible via "Generate Specs" button in device form when editing devices with specs enabled.